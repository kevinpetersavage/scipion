...
{
    addUsageLine( "Polishes the selected particles from the corrected average using frames");
...
void ProgParticlePolishing::produceSideInfo()
{
    ...
    fnAvg =  fnparticleCoords.removeLastExtension() + "_aligned.spi";
