 ...
 ***************************************************************************/
#ifndef _PROG_RECONSTRUCT_ADMM2_HH
#define _PROG_RECONSTRUCT_ADMM2_HH
...
/**@defgroup ReconstructADMMProgram2 Reconstruct Alternating Direction Method of Multipliers
...
class ProgReconsADMM2: public XmippProgram
{
public:
...
public:
	...
	MultidimArray<double> ux, uy, uz, dx, dy, dz, ud, u;
