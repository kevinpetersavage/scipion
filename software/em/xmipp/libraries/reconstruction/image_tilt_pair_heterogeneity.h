...
#ifndef IMAGE_TILT_PAIR_HETEROGENEITY_H_
#define IMAGE_TILT_PAIR_HETEROGENEITY_H_
...
class ProgImageTiltPairHeterogeneity: public XmippProgram
{
...
public:
    ...
    void spheresplit(double and_acc, MetaData &mdangles);
