...
public:
    ...
    void defineParams();
    void readParams();
    void produceSideInfo(Image<double> &V);
    ...
    void computingResolutions(const MultidimArray<double> &p2mask, Image<double> &outputResolution, FileName fnVol, Image<double> &out_filtered);
    void run();
