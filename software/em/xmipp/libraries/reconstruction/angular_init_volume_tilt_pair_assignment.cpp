...
#include "angular_init_volume_tilt_pair_assignment.h"
#include <cstdlib>
#include <iostream>
#include <vector>
#include <string>
...
void ProgInitVolumeTiltPairassignment::defineParams()
{
	//usage
...
void ProgInitVolumeTiltPairassignment::generateProjections(FileName &fnVol, double &smprt)
{
...
void ProgInitVolumeTiltPairassignment::generateFourierStack(const MultidimArray<double> &input_stack,
...
void ProgInitVolumeTiltPairassignment::generateInitialBall(const MetaData &md_u,const MetaData &md_t,
...
void ProgInitVolumeTiltPairassignment::run()
{
